...
- extraction helpers
  ...
  - public peeler: [`../tools/extract_wsx_entries.py`](../tools/extract_wsx_entries.py) — general `u16`-count WSX family (51/52 DAT files; see [`wsx-extraction.md`](wsx-extraction.md))
